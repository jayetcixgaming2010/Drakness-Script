--[[
    Drakness Hub - Optimized Version
...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://101138166721164"
...
NotificacaoNightMystic("Drakness Hub", "Script carregado com sucesso!")

-- ========================================
-- SAVE SYSTEM (Optimized)
-- ========================================
local HttpService = Services.HttpService
local FolderName = "Drakness Hub"
...
NotificacaoNightMystic("Drakness Hub", "✅ Todos os sistemas carregados!")
